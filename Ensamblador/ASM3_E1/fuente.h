...
typedef struct {
  ...
  uint8_t pixeles_alto;   //!< Alto en píxeles de la fuente.
  char primer_caracter;   //!< Código del primer carácter incluido en la fuente.
  char ultimo_caracter;   //!< Código del último carácter incluido en la fuente.

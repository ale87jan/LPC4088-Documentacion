...
const fuente_t fuente_16x32 = {
  ...
  .pixeles_alto = 32,           // Alto en píxeles de la fuente
  .primer_caracter = 32,        // Código del primer carácter incluido en la fuente
  .ultimo_caracter = 255,       // Código del último carácter incluido en la fuente
  .datos = fuente_16x32_datos   // Datos con patrones de puntos de la fuente
};

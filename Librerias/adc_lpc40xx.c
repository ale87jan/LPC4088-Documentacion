...
void adc_inicializar(uint32_t frecuencia_adc, uint8_t canales) {
  ...
  /* El array funciones contiene el valor del campo FUNC para seleccionar la función de entrada
   * analógica en el registro IOCON del puerto y pin de los pines con función de entrada analógica.
   */
 ...
 */
uint16_t adc_convertir(uint8_t canal) {
